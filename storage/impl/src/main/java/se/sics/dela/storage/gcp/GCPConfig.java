...
public class GCPConfig {
  ...
  public static Try<GCPConfig> read(Config config) {
    Optional<String> credentialsFile = config.readValue(GCP_CREDENTIAL_FILE, String.class);
    ...
    String project = config.getValue(GCP_PROJECT, String.class);
    String bucket = config.getValue(GCP_BUCKET, String.class);
