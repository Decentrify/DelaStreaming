...
public class DatagramHandler extends BaseHandler<DatagramPacket> {
  ...
  public DatagramHandler(LedbatNetwork component, Transport protocol) {
  ...
  protected void messageReceived(ChannelHandlerContext ctx, DatagramPacket msg) throws Exception {
    ...
    try {
      ...
      if (o instanceof AckRequestMsg) {
        ...
        ByteBuf buf = ctx.alloc().ioBuffer(LedbatNetwork.INITIAL_BUFFER_SIZE, LedbatNetwork.SEND_BUFFER_SIZE);
