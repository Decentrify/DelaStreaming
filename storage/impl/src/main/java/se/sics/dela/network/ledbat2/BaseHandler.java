 ...
 */
package se.sics.dela.network.ledbat2;
...
public abstract class BaseHandler<M> extends SimpleChannelInboundHandler<M> {
  ...
  protected final LedbatNetwork component;
  protected final Transport protocol;

  public BaseHandler(LedbatNetwork component, Transport protocol) {
  ...
  public void channelActive(ChannelHandlerContext ctx) {
    ...
    try {
      component.extLog.trace("Channel connected: {} {} => {} ({})",
        new Object[]{protocol, ctx.channel().localAddress(), ctx.channel().remoteAddress(), ctx.channel()});
    } finally {
      MDC.clear();
    }
  }
    ...
    try {
      ...
      if (address != null && address instanceof InetSocketAddress) {
        ...
        component.networkException(
          new NetworkException("Error in Channel handler to " + addr, addr, protocol, Optional.of(cause)));
      }
