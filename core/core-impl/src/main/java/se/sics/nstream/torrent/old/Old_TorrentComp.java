...
// */
//public class Old_TorrentComp extends ComponentDefinition {
//
//    private static final Logger LOG = LoggerFactory.getLogger(Old_TorrentComp.class);
...
//
//    public Old_TorrentComp(Init init) {
...
//                    if (content.Request.this.content instanceof HashGet.Request) {
...
//                    if (content.Response.this.content instanceof HashGet.Response) {
...
//    };
//
//    public static class Init extends se.sics.kompics.Init<Old_TorrentComp> {
//
