 ...
 */
public class UpldConnReport implements KompicsEvent {
    ...
    public UpldConnReport(FileIdentifier fileId, KAddress target, Pair<Integer, Integer> queueDelay, double queueAdjustment) {
