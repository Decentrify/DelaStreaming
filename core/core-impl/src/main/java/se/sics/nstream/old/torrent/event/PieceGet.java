...
public class PieceGet {
  ...
  public static class Request implements StreamMsg.Request {
    ...
    protected Request(Identifier msgId, OverlayId overlayId, Map<String, KHint.Summary> cacheHints, String fileName,
      Pair<Integer, Integer> pieceNr) {
      this.msgId = msgId;
    ...
    public Response success(KReference<byte[]> piece) {
      return new Response(msgId, msgId, overlayId, Result.Status.SUCCESS, fileName, pieceNr, ByteBuffer.wrap(piece.
        getValue().get()));
    }
  ...
  public static class RangeRequest implements StreamMsg.Request {
    ...
    protected RangeRequest(Identifier msgId, OverlayId overlayId, Map<String, KHint.Summary> cacheHints, String fileName,
      int blockNr, int from, int to) {
      this.msgId = msgId;
      this.overlayId = overlayId;
      this.cacheHints = cacheHints;
      this.fileName = fileName;
