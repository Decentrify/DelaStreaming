...
public class TorrentExtendedStatusEvent {
    public static class Request extends Direct.Request<Response> implements VoDMngrEvent {
        ...
        public final Result<String> manifestPath;
        
        public Request(Identifier eventId, Identifier torrentId, Result<String> manifestPath) {
            this.eventId = eventId;
            this.torrentId = torrentId;
            this.manifestPath = manifestPath;
        }
        
        public Request(Identifier torrentId, Result<String> manifestPath) {
            this(UUIDIdentifier.randomId(), torrentId, manifestPath);
        }
