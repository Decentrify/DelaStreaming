...
//            return new Response(this, OldResult.success(), fileInfo, torrentInfo);
//        }
//        
//        public Response badRequest(String description) {
//            return new Response(this, OldResult.badRequest(description), null, null);
//        }
//        
//        @Override
...
//        
//        private Response(Request req, OldResult result, FileInfo fileInfo, TorrentInfo torrentInfo) {
//            this.req = req;
//            this.result = result;
