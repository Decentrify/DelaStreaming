 ...
 */
public class DataMngrStateReducer implements PacketReducer<SimpleHistoryPacket, StatePacket>{

    @Override
    public Set<Class> interestedInPackets() {
        Set<Class> packets = new HashSet<>();
        packets.add(DownloadMngrStatePacket.class);
        return packets;
    }
    ...
    @Override
    public SimpleHistoryPacket appendSP(SimpleHistoryPacket current, StatePacket append) {
