 ...
 */
package se.sics.silkold.torrent.channel;
 ...
 */
public class ChannelLeecher {

  private static final Logger LOG = LoggerFactory.getLogger(ChannelLeecher.class);
  public static final String NAME = "dela-conn-channel-leecher-fsm";
  ...
  public interface Event extends FSMEvent {
    ...
    public Identifier getChannelLeecherFSMId();
  }
    ...
    static BaseIdExtractor baseIdExtractor = new BaseIdExtractor() {
      ...
      public Optional<Identifier> fromEvent(KompicsEvent event) throws FSMException {
        if (event instanceof Event) {
          return Optional.of(((Event) event).getChannelLeecherFSMId());
        }
