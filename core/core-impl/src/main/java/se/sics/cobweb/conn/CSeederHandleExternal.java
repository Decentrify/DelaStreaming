 ...
 */
public class CSeederHandleExternal implements FSMExternalState {
  ...
  public CSeederHandleExternal(KAddress selfAdr, Negative<ConnPort> conn, Positive<Network> network) {
