 ...
 */
public class CLeecherHandleExternal implements FSMExternalState {
  ...
  public CLeecherHandleExternal(KAddress selfAdr, Positive<Network> network, Negative<ConnPort> conn) {
