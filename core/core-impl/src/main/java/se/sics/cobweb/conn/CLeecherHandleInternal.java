 ...
 */
public class CLeecherHandleInternal implements FSMInternalState {

  public final FSMId fsmId;
  public Optional<ConnE.Connect1Request> msg1 = Optional.absent();

  private CLeecherHandleInternal(FSMId fsmId) {
    this.fsmId = fsmId;
  }
  ...
  public static class Builder implements FSMInternalStateBuilder {
    ...
    public FSMInternalState newState(FSMId fsmId) {
      return new CLeecherHandleInternal(fsmId);
    }
  }
}
