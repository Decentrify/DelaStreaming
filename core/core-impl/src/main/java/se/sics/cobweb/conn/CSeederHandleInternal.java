 ...
 */
public class CSeederHandleInternal implements FSMInternalState {

  public final FSMId fsmId;
  public Optional<KContentMsg<KAddress, KHeader<KAddress>, CHandleMsg.ConnectToSeeder>> msg1 = Optional.absent();
  public Optional<ConnE.Connect2Request> msg2 = Optional.absent();

  private CSeederHandleInternal(FSMId fsmId) {
    this.fsmId = fsmId;
  }
  ...
  public static class Builder implements FSMInternalStateBuilder {
    ...
    public FSMInternalState newState(FSMId fsmId) {
      return new CSeederHandleInternal(fsmId);
    }
  }
}
