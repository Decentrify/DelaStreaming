 ...
 */
public class SeederHandleOverlordInternal implements FSMInternalState {
  public final FSMId fsmId;
  public Optional<ConnE.Connect2Request> m1 = Optional.absent();
  public Optional<HandleMngrE.SeederConnected> m2 = Optional.absent();
  public Optional<SeederHandleCtrlE.Ready> m3 = Optional.absent();
  
  public SeederHandleOverlordInternal(FSMId fsmId) {
    this.fsmId = fsmId;
  }
  ...
  public static class Builder implements FSMInternalStateBuilder {
    ...
    @Override
    public SeederHandleOverlordInternal newState(FSMId fsmId) {
      return new SeederHandleOverlordInternal(fsmId);
    }
  }
}
