 ...
 */
public class TransferSeederInternal implements FSMInternalState {
  public final FSMId fsmId;
  public MyTorrent.Manifest torrent;
  
  public TransferSeederInternal(FSMId fsmId) {
    this.fsmId = fsmId;
  }
  ...
  public static class Builder implements FSMInternalStateBuilder {
    ...
    public FSMInternalState newState(FSMId fsmId) {
      return new TransferSeederInternal(fsmId);
    }
  }
}
