...
// */
//public class LeecherTransferFSM {
//
//  private static final Logger LOG = LoggerFactory.getLogger(LeecherTransferFSM.class);
...
//  }
//
//  public static MultiFSM multifsm(LeecherTransferExternal es, LeecherTransferInternal.Builder isb,
...
//        .nextStates(LeecherTransferStates.GETTING_META)
//        .buildTransition()
//      .onState(LeecherTransferStates.GETTING_META)
//        .nextStates(LeecherTransferStates.GETTING_META)
//        .toFinal()
//        .buildTransition();
//
//    FSMBuilder.Handlers handlers = FSMBuilder.events()
//      .defaultFallback(LeecherTransferHandlers.handleEventFallback, LeecherTransferHandlers.handleMsgFallback)
//      .positivePort(ConnPort.class)
//        .onEvent(ConnE.SeederConnect.class)
//          .subscribe(LeecherTransferHandlers.handleSeederConnectedMeta, FSMBasicStateNames.START, LeecherTransferStates.GETTING_META)
//        .buildEvents();
