 ...
 */
public class TransferLeecherExternal implements FSMExternalState {

  private ComponentProxy proxy;
  public final OverlayId torrentId;
  
  public final Negative<TransferPort> transferPort;
  
  public TransferLeecherExternal(OverlayId torrentId, Negative<TransferPort> transferPort) {
