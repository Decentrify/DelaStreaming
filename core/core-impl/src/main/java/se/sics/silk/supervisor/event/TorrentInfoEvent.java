...
public class TorrentInfoEvent {
  ...
  public static class DownloadSummary implements StreamEvent, OverlayEvent, LibTFSMEvent {
    ...
    public DownloadSummary(Identifier eventId, OverlayId torrentId, long transferSize, long transferTime) {
      this.eventId = eventId;
    ...
    public DownloadSummary(OverlayId torrentId, long transferSize, long transferTime) {
