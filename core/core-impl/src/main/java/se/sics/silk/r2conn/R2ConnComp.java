 ...
 */
public class R2ConnComp extends ComponentDefinition {

  private static final Logger LOG = LoggerFactory.getLogger(R2ConnComp.class);
  ...
  public static class Init extends se.sics.kompics.Init<R2ConnComp> {
