...
//    tc = mockIn(tc, ctrlP, target, new R1TorrentCtrlEvents.Upload(torrentId));
...
//    seeders.add(seeder);
//    tc = mockIn(tc, ctrlP, target, new R1TorrentCtrlEvents.MetaGetReq(torrentId, seeders));
//    tc = mockOut(tc, ctrlP, target, new PredicateHelper.ContentPredicate(R1TorrentCtrlEvents.MetaGetSucc.class));
//    tc = mockOut(tc, ctrlP, target, torrentBaseInfo(R2TorrentStatus.META_SERVE));
//    tc = mockIn(tc, ctrlP, target, new R1TorrentCtrlEvents.Download(torrentId));
//    tc = mockOut(tc, ctrlP, target, torrentBaseInfo(R2TorrentStatus.HASH));
//    return tc;
//  }
//
