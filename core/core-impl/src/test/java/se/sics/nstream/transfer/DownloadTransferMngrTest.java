...
//    List<Triplet<Integer, Integer, byte[]>> p0, p1, p2, p3, p4, p5;
//    Triplet<Integer, Integer, byte[]> p1_l, p3_l_faulty, p3_l;
//
//    {
...
//
//        p0 = new LinkedList<>();
//        p0.add(Triplet.with(0, 0, new byte[]{0, 1, 2, 3, 4}));
//        p0.add(Triplet.with(0, 1, new byte[]{5, 6, 7, 8, 9}));
//        p1 = new LinkedList<>();
//        p1.add(Triplet.with(1, 0, new byte[]{0, 1, 2, 3, 4}));
//        p1_l = Triplet.with(1, 1, new byte[]{5, 6, 7, 8, 9});
//        p2 = new LinkedList<>();
//        p2.add(Triplet.with(2, 0, new byte[]{0, 1, 2, 3, 4}));
//        p2.add(Triplet.with(2, 1, new byte[]{5, 6, 7, 8, 9}));
//        p3 = new LinkedList<>();
//        p3.add(Triplet.with(3, 0, new byte[]{0, 1, 2, 3, 4}));
//        p3_l_faulty = Triplet.with(3, 1, new byte[]{0, 6, 7, 8, 9});
//        p3_l = Triplet.with(3, 1, new byte[]{5, 6, 7, 8, 9});
//        p4 = new LinkedList<>();
//        p4.add(Triplet.with(4, 0, new byte[]{0, 1, 2, 3, 4}));
//        p4.add(Triplet.with(4, 1, new byte[]{5, 6, 7, 8, 9}));
//        p5 = new LinkedList<>();
//        p5.add(Triplet.with(5, 0, new byte[]{0, 1, 2, 3, 4}));
//        p5.add(Triplet.with(5, 1, new byte[]{5}));
//    }
//
//    @Test
...
//        //
//        Assert.assertTrue(dtm.nextWork());
//        Assert.assertFalse(dtm.pendingWork());
//        Assert.assertEquals(Pair.with(0, 0), dtm.nextBlock());
...
//        Assert.assertEquals(expectedHint, hint.blocks);
//        //b1, b2
//        Assert.assertEquals(Pair.with(1, 5), dtm.nextBlock());
//        Assert.assertEquals(Pair.with(2, 5), dtm.nextBlock());
//        //write block 2
...
//        dtm.writePiece(p1_l.getValue0(), p1_l.getValue1(), p1_l.getValue2(), p1WC); //write last piece of b1
...
//        Assert.assertEquals(expectedHint, hint.blocks);
//        //b3 - faulty piece
//        Assert.assertEquals(Pair.with(3, 5), dtm.nextBlock());
//        writeHash(proxy, syncExHandler, dtm, 3, defHash);
//        writeIncompleteBlock(proxy, syncExHandler, dtm, mb, p3);
//        MockPWC p3WC = new MockPWC();
//        dtm.writePiece(p3_l_faulty.getValue0(), p3_l_faulty.getValue1(),p3_l_faulty.getValue2(), p3WC); //write last, faulty, piece of b3
...
//        writeIncompleteBlock(proxy, syncExHandler, dtm, mb, p3);
//        p3WC = new MockPWC();
//        dtm.writePiece(p3_l.getValue0(), p3_l.getValue1(), p3_l.getValue2(),  p3WC); //write last piece of b3
//        Assert.assertTrue(p3WC.done);
//        Assert.assertTrue(p3WC.waitingOnBlock);
//        validator = proxy.validateNext();
...
//        //b4
//        //reset piece
//        dtm.pieceTimeout(4, 1);
//        //complete
//        writeHash(proxy, syncExHandler, dtm, 4, defHash);
//        Assert.assertEquals(Pair.with(4, 5), dtm.nextBlock());
...
//        Assert.assertEquals(Pair.with(5, 1), dtm.nextBlock());
...
//            List<Triplet<Integer, Integer, byte[]>> pieces) {
//        Iterator<Triplet<Integer, Integer, byte[]>> it = pieces.iterator();
//        while (it.hasNext()) {
//            Triplet<Integer, Integer, byte[]> piece = it.next();
//            MockPWC pieceWC = new MockPWC();
//
//            if (it.hasNext()) {
//                dtm.writePiece(piece.getValue0(), piece.getValue1(), piece.getValue2(), pieceWC);
