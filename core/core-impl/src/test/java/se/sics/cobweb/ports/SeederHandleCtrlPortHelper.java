 ...
 */
public class SeederHandleCtrlPortHelper {
  public static List<Class> indication() {
    List<Class> events = new LinkedList<>();
    events.add(SeederHandleCtrlE.ShutdownAck.class);
    events.add(SeederHandleCtrlE.Report.class);
    return events;
  }

  public static List<Class> request() {
    List<Class> events = new LinkedList<>();
    events.add(SeederHandleCtrlE.Shutdown.class);
    return events;
  }
}
