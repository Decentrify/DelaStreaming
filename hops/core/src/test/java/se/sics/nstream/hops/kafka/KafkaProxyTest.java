...
public class KafkaProxyTest {
  ...
  private static ByteBuf stream1;
  private static IdentifierFactory eventIds;
  ...
  public void simpleTest() {
    ...
    DStorageWrite.Request req1 = new DStorageWrite.Request(eventIds.randomId(), streamId, 0, v1);
    byte[] v2 = new byte[2 * 18];
    stream1.readBytes(v2);
    DStorageWrite.Request req2 = new DStorageWrite.Request(eventIds.randomId(), streamId, 18, v2);
    byte[] v3 = new byte[10];
    stream1.readBytes(v3);
    DStorageWrite.Request req3 = new DStorageWrite.Request(eventIds.randomId(), streamId, 3 * 18, v3);
    byte[] v4 = new byte[5];
    stream1.readBytes(v4);
    DStorageWrite.Request req4 = new DStorageWrite.Request(eventIds.randomId(), streamId, 3 * 18 + 10, v4);
    byte[] v5 = new byte[3];
    stream1.readBytes(v5);
    DStorageWrite.Request req5 = new DStorageWrite.Request(eventIds.randomId(), streamId, 3 * 18 + 15, v5);
    byte[] v6 = new byte[21];
    stream1.readBytes(v6);
    DStorageWrite.Request req6 = new DStorageWrite.Request(eventIds.randomId(), streamId, 4 * 18, v6);
    byte[] v7 = new byte[18];
    stream1.readBytes(v7);
    DStorageWrite.Request req7 = new DStorageWrite.Request(eventIds.randomId(), streamId, 5 * 18 + 3, v7);
    byte[] v8 = new byte[15];
    stream1.readBytes(v8);
    DStorageWrite.Request req8 = new DStorageWrite.Request(eventIds.randomId(), streamId, 6 * 18 + 3, v8);
