...
import se.sics.nstream.test.TorrentGetEqc;
...
public class TransferTorrentSerializerTest {
    ...
    public void simpleReqTest() {
        ...
        TorrentGetEqc.Request eqc = new TorrentGetEqc.Request();
        TorrentGet.Request original, copy;
        ByteBuf serializedOriginal, serializedCopy;
        
        original = new TorrentGet.Request(new IntIdentifier(10));
        ...
        copy = (TorrentGet.Request) serializer.fromBinary(serializedCopy, Optional.absent());
    ...
    public void simpleRespTest() {
        ...
        TorrentGetEqc.Response eqc = new TorrentGetEqc.Response();
        TorrentGet.Response original, copy;
        ByteBuf serializedOriginal, serializedCopy;
        
        original = new TorrentGet.Response(UUIDIdentifier.randomId(), new IntIdentifier(10), Result.Status.SUCCESS, new byte[]{1,2,3});
        serializedOriginal = Unpooled.buffer();
        serializer.toBinary(original, serializedOriginal);
        ...
        copy = (TorrentGet.Response) serializer.fromBinary(serializedCopy, Optional.absent());
