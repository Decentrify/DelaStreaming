 ...
 */
public class BlockGetEqc {

    public static class Request implements EqualComparator<BlockGet.Request> {
        ...
        @Override
        public boolean isEqual(BlockGet.Request o1, BlockGet.Request o2) {
