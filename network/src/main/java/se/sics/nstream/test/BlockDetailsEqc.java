...
public class BlockDetailsEqc implements EqualComparator<BlockDetails> {
    ...
    @Override
    public boolean isEqual(BlockDetails o1, BlockDetails o2) {
        if (o1.blockSize != o2.blockSize) {
            return false;
        }
        if (o1.defaultPieceSize != o2.defaultPieceSize) {
            return false;
        }
        if (o1.lastPieceSize != o2.lastPieceSize) {
            return false;
        }
        if (o1.nrPieces != o2.nrPieces) {
            return false;
        }
        return true;
    }
